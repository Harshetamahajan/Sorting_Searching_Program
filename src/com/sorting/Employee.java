...
public class Employee {
    ...
    public static Employee[] employeeList2() {
        ...
        employees[0] = new Employee(101,"Ketki", 50000);
        employees[1] = new Employee(102,"sam", 60000);
        employees[2] = new Employee(103,"jay", 55000);
        employees[3] = new Employee(104,"kanu", 45000);
        employees[4] = new Employee(105,"chinu", 75000);
        return employees;
    }
